                                        ...
                                        foreach ($institution as $key => $u): 
                                            if($u->active == 1){  ?>
                                                <tr>
                                                    <td>{{$u->name}}</td>
                                                    <td>{{$u->shortName}}</td>
                                                    <td align="center"><input type="button" value="Editar" class="btn btn-primary" onclick="Editar( '{{$u->name}} ', '{{$u->shortName}} ', '{{$u->id}}' )"> 
                                                        &nbsp;&nbsp; 
                                                        <input type="button" value="Eliminar" class="btn btn-danger" onclick="Eliminar( '{{$u->name}} ', '{{$u->shortName}} ','{{$u->id}}' )">
                                                    </td>
                                                </tr>
                                            <?php }
                                        endforeach 
