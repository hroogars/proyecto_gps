                                                        ...
                                                        foreach ($career as $key => $u): 
                                                            if($u->active == 1){  ?>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="button" value="Editar" class="btn btn-primary" onclick="EditarCarrera( '{{$u->name}} ', '{{$u->shortName}} ', '{{$u->institution->id}}' , '{{$u->id}}' )"> 
                                                                        &nbsp;&nbsp; 
                                                                        <input type="button" value="Eliminar" class="btn btn-danger" onclick="EliminarCarrera( '{{$u->name}} ', '{{$u->shortName}} ', '{{$u->institution->id}}' , '{{$u->id}}' )">
                                                                    </td>
                                                                </tr>
                                                        <?php }
                                                        endforeach ?>
...
<script>
    ...
    function AñadirCarrera(){
        var inputOptionsInstituciones = $.get("{{route('career.data2')}}");
