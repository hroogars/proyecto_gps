...
<html class="no-js" lang="es">
    <head>
        ...
        <!-- Personal -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('dist/css/sweetalert2.min.css')); ?>">
    ...
    <body>
                                    ...
                                    <ul class="notifications-container">
                                        <li>
                                            <a href="" class="notification-item">
                                                <div class="img-col">
                                                    <div class="img" style="background-image: url(<?php echo e(asset('assets/faces/default.png')); ?>)"></div>
                                                </div>
                                                <div class="body-col">
                                                    <p>
                            ...
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('userType.index')); ?>"> Tipos Usuarios </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('permission.index')); ?>"> Permisos </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('userTypePermission.index')); ?>"> Tipo Usuario Permiso </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('institution.index')); ?>"> Instituciones </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(route('career.index')); ?>"> Carreras </a>
                                        </li>
                                    </ul>
                                </li>
        ...
        <script type="text/javascript" src="<?php echo e(asset('dist/js/sweetalert2.min.js')); ?>"></script>
        <!--script type="text/javascript" src="<?php echo e(asset('plugins/jQuery/jquery-3.1.1.min.js')); ?>"></script-->
